...
//               className="relative p-1.5 lg:p-2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
//               aria-label="Shopping cart"
//             >
//               <ShoppingCart className="h-5 w-5 lg:h-6 lg:w-6" />
//               {cartItemCount > 0 && (
//                 <span className="absolute -top-1 -right-1 bg-red-500 dark:bg-red-600 text-white text-xs rounded-full h-4 w-4 lg:h-5 lg:w-5 flex items-center justify-center">
