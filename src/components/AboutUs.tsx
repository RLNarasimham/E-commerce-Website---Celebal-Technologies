  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        accessible and affordable for everyone. From electronics and clothing to
        books and home goods, we offer a carefully curated selection to meet the
        diverse needs of our customers.
      </p>

      <p className="text-gray-700 dark:text-gray-300 mb-4">
        Our team is passionate about e-commerce, design, and customer
        satisfaction. We are constantly working to improve our platform, add new
        products, and provide the best possible online shopping experience.
      </p>

      <p className="text-gray-700 dark:text-gray-300 mb-4">
        We believe in transparency, security, and excellent customer service.
        Whether you are a first-time visitor or a loyal customer, we are here to
